...
class PermissionsAsProperty : ReadOnlyProperty<ComponentActivity, PermissionsAsProperty> {
    companion object {
    ...
    override fun getValue(thisRef: ComponentActivity, property: KProperty<*>): PermissionsAsProperty {
