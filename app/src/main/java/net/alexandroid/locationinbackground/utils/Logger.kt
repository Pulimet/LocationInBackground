...
import net.alexandroid.locationinbackground.utils.Logger.logIt
import net.alexandroid.locationinbackground.utils.Logger.whoIsCallingMe
...
object Logger {
    private const val packageName = "net.alexandroid.locationinbackground"
    private const val isLogsShown = true
    ...
    private const val classNameLength = 20
